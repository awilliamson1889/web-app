...
class TestApiSkill(unittest.TestCase):
    ...
    wrong_json_msg = "Skill 1 validation error for SkillSchema\nname\n  field required (type=value_error.missing)"
    not_valid_json_msg = "Skill 1 validation error for SkillSchema\nname\n  Name length too big! (type=value_error)"
    ...
    def test_get_skill_wrong_id_case1(self, mock_abort):
        ...
        mock_abort.assert_called_once_with(404, message="No such skill with ID=one")
    ...
    @patch('department_app.rest.skill.abort')
    @patch('department_app.rest.skill.CRUDSkill.get')
    def test_get_skill_wrong_id_case3(self, mock_get_skill, mock_abort):
        """Api should return information about skill."""
        mock_get_skill.return_value = None
        Skill.get(1.0)

        mock_abort.assert_called_once_with(404, message="No such skill with ID=1.0")
    ...
    def test_put_skill_success(self,  mock_update):
        """Api should return information about skill."""
    ...
    @patch('department_app.rest.skill.abort')
    @patch('department_app.rest.skill.CRUDSkill.update')
    def test_put_skill_fail(self, mock_update, mock_abort):
        """Api should return information about skill."""
        with app.test_request_context(json=self.post_valid_data):
    ...
    @patch('department_app.rest.skill.abort')
    def test_put_skill_not_valid(self, mock_abort):
        """Api should return information about skill."""
    ...
    @patch('department_app.rest.skill.abort')
    def test_put_skill_wrong_json(self, mock_abort):
        """Api should return information about skill."""
    ...
    @patch('department_app.rest.skill.abort')
    def test_post_skill_not_valid(self, mok_abort):
        """Api should return information about skill."""
        with app.test_request_context(json=self.post_invalid_data):
            SkillList.post()
    ...
    @patch('department_app.rest.skill.abort')
    def test_post_skill_wrong_json(self, mock_abort):
        """Api should return information about skill."""
        with app.test_request_context(json=self.wrong_json):
            SkillList.post()
